...
- `--attendees` — comma-separated MarketBliss agent slugs. Valid: `marketing-supervisor`, `market-intelligence`, `audience-persona`, `seo-analyst`, `campaign-strategist`, `analytics-experimentation`, `contextual-copywriter`, `brand-narrative`, `executive-producer`, `shot-list-designer`, `talent-ip-coordinator`, `media-buyer-bidder`, `lifecycle-crm`, `brand-safety-compliance`, `memory-steward`. Also `cmo` (resolves to `<AIAPP_BASE>/ExecutiveSuite/plugins/executive-suite/agents/cmo.md`).
- `--format`:
